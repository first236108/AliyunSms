...
require_once 'msg_sdk/vendor/autoload.php';

// require_once 'lib/TokenGetterForAlicom.php';//__DIR__ . 
// require_once 'lib/TokenForAlicom.php';//__DIR__ . 
...
class Msg
{
    ...
    {
        $this->tokenGetter = new lib\TokenGetterForAlicom(
            $accountId,
            $accessKeyId,
            $accessKeySecret
        );
